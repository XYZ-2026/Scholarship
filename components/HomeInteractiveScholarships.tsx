          ...
          <article key={s.id} className="card-premium hover-lift cursor-pointer group">
            ...
            <div className="p-6 pb-7">
              ...
              <div className="mt-7 flex gap-3">
                <a href="#scholarships" className="flex-1 h-[44px] rounded-xl bg-[#690B1B] text-white text-[13.5px] font-bold flex items-center justify-center gap-2 hover:bg-[#7A1022] hover:shadow-[0_6px_20px_rgba(105,11,27,0.18)] transition-all duration-300 cursor-pointer">
                  Apply Now
                ...
                <button aria-label="Save scholarship" className="h-[44px] w-[44px] shrink-0 rounded-xl border border-[#E7E2DE] bg-[#FAFAF9] flex items-center justify-center text-[#B5B0AA] hover:text-[#690B1B] hover:border-[#690B1B]/30 transition-all duration-300 cursor-pointer">
